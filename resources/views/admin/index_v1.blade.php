...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="/status/admin/css/bootstrap.min.css?v=3.3.6" rel="stylesheet">
...
<body class="gray-bg">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="project-people">
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/status/admin/img/a3.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/status/admin/img/a1.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/status/admin/img/a2.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/status/admin/img/a4.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/status/admin/img/a5.jpg"></a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="project-people">
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/status/admin/img/a7.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/status/admin/img/a6.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="/status/admin/img/a3.jpg"></a>
                                                </td>
                                                <td class="project-actions">
                                                    <a href="projects.html#" class="btn btn-white btn-sm"><i class="fa fa-folder"></i> 查看 </a>
    ...
    <script src="/status/admin/js/plugins/layer/layer.min.js"></script>
    <!-- Flot -->
    <script src="/status/admin/js/plugins/flot/jquery.flot.js"></script>
    <script src="/status/admin/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="/status/admin/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="/status/admin/js/plugins/flot/jquery.flot.pie.js"></script>
    <!-- 自定义js -->
    <script src="/status/admin/js/content.js"></script>
    <!--flotdemo-->
